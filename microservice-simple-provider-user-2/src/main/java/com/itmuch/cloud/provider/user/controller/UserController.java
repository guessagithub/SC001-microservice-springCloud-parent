...
public class UserController {
	...
	public UserEntity findById(@PathVariable Integer id) {
		...
		userEntity.setDesc("我是User服务提供者【2】，调用了接口【findById】。");
		System.out.println("我是User服务提供者【2】，调用了接口【findById】。");
		return userEntity;
	} 
	...
	public List<UserEntity> userList() {
		...
		for(UserEntity user : userList) {
			user.setDesc("我是User服务提供者【2】，调用了接口【userList】。");
			System.out.println("我是User服务提供者【2】，调用了接口【userList】。");
		}
		return userList;
	}
	...
	public List<UserEntity> findByName(@PathVariable String name) {
		...
		for(UserEntity user : userList) {
			user.setDesc("我是User服务提供者【2】，调用了接口【findByName】。");
			System.out.println("我是User服务提供者【2】，调用了接口【findByName】。");
		}
		return userList;
	}
